...
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_INDEX			uint32_t(1)<<2
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_INDEX16			uint32_t(1)<<3
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_DEPTH			uint32_t(1)<<4
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_STENCIL			uint32_t(1)<<5
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_DEPTHSTENCIL	uint32_t(1)<<6
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGB_1		uint32_t(1)<<7
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGBA_1	uint32_t(1)<<8
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_INDEX_1			uint32_t(1)<<9
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGB_2		uint32_t(1)<<10
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGBA_2	uint32_t(1)<<11
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_INDEX_2			uint32_t(1)<<12
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGB_3		uint32_t(1)<<13
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_COLOR_RGBA_3	uint32_t(1)<<14
#define LIW_FRAMEBUFFER_ATTACHMENT_FLAG_INDEX_3			uint32_t(1)<<15
