...
namespace LIW {
	...
	public:
		...
		LIWDArray<T, LIWMem_Default, LIWDynamicExpandType_Constant> m_components;
		LIWDArray<T, LIWMem_Default, LIWDynamicExpandType_Constant> m_componentsInactive;
		LIWDArray<T, LIWMem_Default, LIWDynamicExpandType_Constant> m_componentsAdd;
		LIWDArray<HandleData, LIWMem_Default, LIWDynamicExpandType_Constant> m_handles;
