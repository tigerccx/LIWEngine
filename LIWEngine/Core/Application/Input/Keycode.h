...
namespace LIW {
	...
	enum KeyboardKeys {
		KEYBOARD_UNKNOWN = -1,  // Unknow button
		...
		KEYBOARD_SEMICOLON = 0xBA, //Semicolon	(;)
		KEYBOARD_PLUS = 0xBB,  // Plus Key   (+)
		KEYBOARD_COMMA = 0xBC,  // Comma Key  (,)
		KEYBOARD_MINUS = 0xBD,  // Minus Key  (-)
		KEYBOARD_PERIOD = 0xBE,  // Period Key (.)
		KEYBOARD_SLASH = 0xBF,  // Slash Key (/)
		KEYBOARD_GRAVE_ACCENT = 0xC0,  // Grave Accent Key (`)
		KEYBOARD_LBRACKET = 0xDB,  // Left Bracket Key ([)
		KEYBOARD_BACKSLASH = 0xDC,  // Backslash Key (\)
		KEYBOARD_RBRACKET = 0xDD,  // Right Bracket Key (])
		KEYBOARD_APOSTROPHE = 0xDE,  // Apostrophe Key (')
