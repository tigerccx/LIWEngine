...
public:
    ...
    LIWPointer<LIWShader, LIWMem_Default> m_shader_standardMaterial;

    LIWPointer<LIWShaderProgram, LIWMem_Default> m_shaderProgram;
    LIWPointer<LIWShaderProgram, LIWMem_Default> m_shaderProgramStandard;

    LIWPointer<LIWMaterial, LIWMem_Default> m_materialTest;
    LIWPointer<LIWMaterial, LIWMem_Default> m_materialStandard;
