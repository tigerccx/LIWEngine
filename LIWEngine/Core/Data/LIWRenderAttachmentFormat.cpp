...
namespace LIW {
	const std::unordered_map<LIWRenderAttachmentFormat, GLenum> LIWRenderAttachmentFormat_2_GLAttachment =
	{
		...
		{LIWRenderAttachmentFormat_Index16,			GL_COLOR_ATTACHMENT0		},
	...
	const std::unordered_map<LIWRenderAttachmentFormat, GLint> LIWRenderAttachmentFormat_2_GLFormat =
	{
		...
		{LIWRenderAttachmentFormat_Index16,			GL_R16UI				},
